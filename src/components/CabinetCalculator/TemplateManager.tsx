...
const TemplateManager: React.FC<TemplateManagerProps> = ({
  ...
  const handleTemplateCreated = async (template: CabinetTemplate) => {
    try {
      await CabinetStorageService.saveTemplate(template);
  ...
  const handleTemplateUpdated = async (template: CabinetTemplate) => {
    try {
      await CabinetStorageService.saveTemplate(template);
      await loadCustomTemplates();
  ...
  const handleDeleteTemplate = async (templateId: string) => {
    ...
    try {
      await CabinetStorageService.deleteTemplate(templateId);
      await loadCustomTemplates();
