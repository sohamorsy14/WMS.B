...
export interface BOM {
  ...
  name: string;
  version: string;
  linkedType: 'order' | 'prototype' | 'cabinet';
  linkedId: string;
  linkedNumber: string;
  status: 'draft' | 'approved' | 'in_production' | 'completed' | 'obsolete';
  description: string;
  category: string;
  items: BOMItem[];
  totalCost: number;
...
export interface Prototype {
  ...
  name: string;
  description: string;
  status: 'concept' | 'design' | 'testing' | 'approved' | 'rejected';
  category: string;
  designer: string;
  createdDate: string;
  approvalDate?: string;
...
export interface Requisition {
  ...
  orderNumber?: string;
  bomNumber?: string;
  status: 'draft' | 'pending' | 'approved' | 'rejected' | 'issued' | 'completed';
